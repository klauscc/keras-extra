...
def random_transform(image, boxes, image_data_generator, seed=None):
    if seed is None:
    ...
    for index in range(boxes.shape[0]):
        ...
        cv2.rectangle(mask, (b[0], b[1]), (b[2], b[3]),
                      (255, ) * image.shape[-1], -1)
...
def resize_image(img, min_side=600, max_side=1024, target_size=None):
    ...
    if target_size != None:
        ...
        scale_h = target_size / rows
        scale_w = target_size / cols
    else:
